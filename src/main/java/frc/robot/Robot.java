...
public class Robot extends TimedRobot {
  ...
  private double dPadDown = 180;
  private double dPadUp = 0;
  ...
  public void teleopPeriodic()
  {
    ...
    if(true)//Robot.intake.intakeStowed = false)
    {
      ...
      if(xboxDrv.getPOV() == dPadUp)
      {
        elevator.manualPivotControl(upPower);
      }
      else if(xboxDrv.getPOV() == dPadDown)
      {
        elevator.manualPivotControl(downPower);
      }
      else if(xboxDrv.getPOV() == 90.0)
      {
